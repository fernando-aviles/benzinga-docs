...
* [get](#get) - Obtener informes de transacciones gubernamentales

<div id="get">
  ## obtener
</div>

Obtener informes de transacciones gubernamentales
...
| --------- | ----------------------------------------------------------------------------------------------- | -------------------------- | ----------------------------------------------------- |
| `request` | [GetGovernmentTradeReportsRequest](../../models/operations/GetGovernmentTradeReportsRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que se usará para la petición. |
