...
[&lt; ATRÁS](/es/sdks/languages/java#logos)
...
* [bulkSync](#bulksync) - Obtener logotipos para las claves de búsqueda especificadas
* [search](#search) - Obtener logotipos para las claves de búsqueda especificadas

<div id="bulksync">
  ## bulkSync
</div>

Obtener logotipos para las claves de búsqueda especificadas
...
| --------- | --------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------- |
| `request` | [LogoBulkSyncRequest](../../models/operations/LogoBulkSyncRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que debe usarse para la petición. |
...
Obtiene logotipos para las claves de búsqueda indicadas
