---
title: "Transacción con información privilegiada"
...
* [get](#get) - Obtener una transacción con información privilegiada

<div id="get">
  ## get
</div>

Obtener una transacción con información privilegiada
...
| --------- | --------------------------------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------ |
| `request` | [GetInsiderTransactionRequest](../../models/operations/GetInsiderTransactionRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que se utilizará para esta solicitud. |
