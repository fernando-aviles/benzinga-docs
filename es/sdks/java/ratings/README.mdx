...
[&lt; ATRÁS](/es/sdks/languages/java#ratings)
...
Devuelve datos sobre calificaciones de analistas
...
| --------- | ----------------------------------------------------------------- | -------------------------- | --------------------------------------------------- |
| `request` | [GetRatingsRequest](../../models/operations/GetRatingsRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que se usará en la petición. |
