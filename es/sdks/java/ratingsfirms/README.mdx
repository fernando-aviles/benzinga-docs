...
[&lt; ATRÁS](/es/sdks/languages/java#ratingsfirms)
...
| --------- | --------------------------------------------------------------------------- | -------------------------- | ----------------------------------------------------- |
| `request` | [GetRatingsFirmsRequest](../../models/operations/GetRatingsFirmsRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que se usará para la petición. |
