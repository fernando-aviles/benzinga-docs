...
* [get](#get) - Obtener datos de tendencias del ticker
* [getList](#getlist) - Obtener la lista de datos de tendencias de tickers

<div id="get">
  ## get
</div>

Obtiene datos de tendencia del ticker
...
| --------- | --------------------------------------------------------------------------------- | -------------------------- | ---------------------------------------- |
| `request` | [GetTickerTrendDataRequest](../../models/operations/GetTickerTrendDataRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que se utilizará. |
...
Obtiene datos de la lista de tendencia del ticker
...
| Parámetro | Tipo                                                                                      | Obligatorio                | Descripción                                               |
| --------- | ----------------------------------------------------------------------------------------- | -------------------------- | --------------------------------------------------------- |
| `request` | [GetTickerTrendListDataRequest](../../models/operations/GetTickerTrendListDataRequest.md) | :heavy&#95;check&#95;mark: | El objeto de solicitud que se utilizará para la petición. |
