...
* [getShareClass](#getshareclass) - Obtener la clase de acciones V2.1
* [getShareClassProfile](#getshareclassprofile) - Obtener el perfil de la clase de acciones V2.1
* [get](#get) - Obtener Fundamentales V2
* [getAssetClassification](#getassetclassification) - Obtener la clasificación de activos V2.1
...
* [getSharePriceRatios](#getsharepriceratios) - Obtener ratios de cotización V3
