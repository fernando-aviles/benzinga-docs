...
| ---------- | ---------------------- | -------------------------- | ---------------- |
| `tickers`  | List&lt;*String*&gt;   | :heavy&#95;minus&#95;sign: | Tíkeres          |
| `callId`   | List&lt;*String*&gt;   | :heavy&#95;minus&#95;sign: | ID de la llamada |
...
Obtener archivos de audio de las transcripciones de llamadas de resultados
