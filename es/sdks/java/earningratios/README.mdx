...
* [get](#get) - Obtener ratios de rentabilidad V2.1

<div id="get">
  ## get
</div>

Obtiene los ratio de rentabilidad para una lista de symbols, ISIN o CIK
...
| ------------ | ------------------------ | -------------------------- | ------------------------------------ |
| `symbols`    | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | Lista de symbols separados por comas |
