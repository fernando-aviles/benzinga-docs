...
* [getAlphaBeta](#getalphabeta) - Alpha Beta V2.1 を取得
* [getCompanyV21](#getcompanyv21) - 会社データ v2.1 を取得
* [getCompanyProfileV21](#getcompanyprofilev21) - 会社概要 v2.1 を取得
* [getShareClass](#getshareclass) - 株式クラス V2.1 を取得
* [getShareClassProfile](#getshareclassprofile) - 株式クラス概要 V2.1 を取得
...
| パラメータ        | 型                        | 必須                         | 説明                  |
| ------------ | ------------------------ | -------------------------- | ------------------- |
| `symbols`    | *String*                 | :heavy&#95;check&#95;mark: | symbolsをカンマ区切りで指定したリスト |
...
| パラメータ        | 型                        | 必須                         | 説明             |
| ------------ | ------------------------ | -------------------------- | -------------- |
| `symbols`    | *String*                 | :heavy&#95;check&#95;mark: | symbolsのカンマ区切りリスト |
| `asOf`       | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 基準日            |
| `period`     | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 期間             |
| `reportType` | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | レポートタイプ         |
...
| パラメータ        | 型                        | 必須                         | 説明             |
| ------------ | ------------------------ | -------------------------- | -------------- |
| `symbols`    | *String*                 | :heavy&#95;check&#95;mark: | カンマ区切りのsymbolsリスト |
| `asOf`       | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 基準日            |
| `period`     | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 期間             |
| `reportType` | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | レポートタイプ         |
...
| パラメータ        | 型                        | 必須                         | 説明            |
| ------------ | ------------------------ | -------------------------- | ------------- |
| `symbols`    | *String*                 | :heavy&#95;check&#95;mark: | カンマ区切りのsymbols一覧 |
| `asOf`       | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 基準日           |
| `period`     | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 期間            |
| `reportType` | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | レポートタイプ       |
...
| パラメータ        | 型                        | 必須                         | 説明                |
| ------------ | ------------------------ | -------------------------- | ----------------- |
| `symbols`    | *String*                 | :heavy&#95;check&#95;mark: | symbolsをカンマ区切りで指定します |
| `asOf`       | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 基準日               |
| `period`     | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 期間                |
| `reportType` | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | レポートタイプ           |
...
| パラメータ     | 型                        | 必須                         | 説明              |
| --------- | ------------------------ | -------------------------- | --------------- |
| `symbols` | *String*                 | :heavy&#95;check&#95;mark: | カンマ区切りのsymbolsのリスト |
| `from`    | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 開始日             |
| `to`      | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 終了日             |
