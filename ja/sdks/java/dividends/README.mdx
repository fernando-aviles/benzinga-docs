...
* [getV22](#getv22) - 配当金情報を取得 V2.2
* [get](#get) - 配当金情報を取得 V2 &amp; V2.1
...
| パラメータ     | 型                                                                           | 必須                         | 説明                         |
| --------- | --------------------------------------------------------------------------- | -------------------------- | -------------------------- |
| `request` | [GetDividendsV22Request](../../models/operations/GetDividendsV22Request.md) | :heavy&#95;check&#95;mark: | このリクエストで使用するリクエストオブジェクトです。 |
...
| パラメータ     | 型                                                                     | 必須                         | 説明                |
| --------- | --------------------------------------------------------------------- | -------------------------- | ----------------- |
| `request` | [GetDividendsRequest](../../models/operations/GetDividendsRequest.md) | :heavy&#95;check&#95;mark: | リクエストに使用するオブジェクト。 |
