...
| パラメータ     | 種別                                                        | 必須                   | 説明            |
| --------- | ----------------------------------------------------------- | -------------------------- | ---------------------- |
| `request` | [GetNewsRequest](../../models/operations/GetNewsRequest.md) | :heavy&#95;check&#95;mark: | リクエストに使用するリクエストオブジェクト。 |
...
| パラメータ          | 種別                        | 必須                         | 説明         |
| -------------- | ------------------------ | -------------------------- | ---------- |
| `updatedSince` | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign: | 更新日時 (以降)  |
