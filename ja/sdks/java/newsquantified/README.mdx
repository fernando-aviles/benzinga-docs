...
* [取得](#get) - Newsquantifiedデータを取得

<div id="get">
  ## 取得
</div>

Newsquantified データを取得
...
| パラメータ     | 型                                                                                       | 必須                         | 説明                       |
| --------- | --------------------------------------------------------------------------------------- | -------------------------- | ------------------------ |
| `request` | [GetNewsquantifiedDataRequest](../../models/operations/GetNewsquantifiedDataRequest.md) | :heavy&#95;check&#95;mark: | リクエストに使用するリクエストオブジェクトです。 |
