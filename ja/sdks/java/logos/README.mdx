...
* [bulkSync](#bulksync) - 指定した検索キーに対応するロゴを取得
* [search](#search) - 指定した検索キーに対応するロゴを取得
...
| パラメータ     | 種別                                                                        | 必須                         | 説明                     |
| --------- | ------------------------------------------------------------------------- | -------------------------- | ---------------------- |
| `request` | [GetSearchLogosRequest](../../models/operations/GetSearchLogosRequest.md) | :heavy&#95;check&#95;mark: | リクエストに使用するリクエストオブジェクト。 |
